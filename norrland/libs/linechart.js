...
var VERSION_INFO = { version: "1.0.21", build: 1511785908673 };
...
var LCComponent = Component.extend("linechart", {
  init: function init(config, context) {
    ...
    this.model_binds = {
      ...
      "change:entities.show": function changeEntitiesShow() {
        _this.values = null;
      },
  ...
  updateShow: function updateShow() {
    ...
    if (this.all_values && this.values) {
      this.entityLabels.each(function (d, index) {
        ...
        var _this$getColorsByValu = _this.getColorsByValue(_this.values.color[d[KEY]]),
  ...
  updateColors: function updateColors() {
    ...
    this.entityLabels.each(function (d, index) {
      ...
      var _this$getColorsByValu2 = _this.getColorsByValue(valuesColor[d[KEY]]),
    ...
    this.entityLines.each(function (d, index) {
      ...
      var _this$getColorsByValu3 = _this.getColorsByValue(valuesColor[d[KEY]]),
  ...
  redrawDataPoints: function redrawDataPoints() {
    ...
    this.model.marker.getFrame(this.time, function (values, time) {
      ...
      _this.entityLines.each(function (d, index) {
        ...
        var _this$getColorsByValu4 = _this.getColorsByValue(values.color[d[KEY]]),
